...
public class CartItemModel {
    ...
    public CartItemModel(int type, int productImage, String productTitle, int freeCoupons, String productPrice, String productCuttedPrice, int productQuantity, int offersApplied, int couponsApplied) {
        this.type = type;
